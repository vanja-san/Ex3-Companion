...
private class Ex3EnglishLangProvider(
	...
	override fun generateTranslations(
		...
		translationBuilder.add("ex3companion.tooltip.health", "\u2764 %s / %s")
		translationBuilder.add("ex3companion.tooltip.level", "\u2726 Lv. %s \u00b7 %s XP")
		translationBuilder.add("ex3companion.tooltip.combat", "\u2694 %s dmg \u00b7 %ss")
...
private class Ex3RussianLangProvider(
	...
	override fun generateTranslations(
		...
		translationBuilder.add("ex3companion.tooltip.health", "❤ %s / %s")
		translationBuilder.add("ex3companion.tooltip.level", "✦ Ур. %s · %s опыта")
		translationBuilder.add("ex3companion.tooltip.combat", "⚔ %s урн. · %sс")
