...
│   │   ├── config/              # Server gameplay config (JSON, synced to clients; operator check via MC 26.3 permissions)
...
- Server-tab controls are enabled only when the player is an operator (MC 26.3
